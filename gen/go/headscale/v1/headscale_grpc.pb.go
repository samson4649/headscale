...
type HeadscaleServiceClient interface {
	...
	// --- ACLs start ---
	ListACLPolicy(ctx context.Context, in *ListACLPolicyRequest, opts ...grpc.CallOption) (*ListACLPolicyResponse, error)
}
...
func (c *headscaleServiceClient) ListACLPolicy(ctx context.Context, in *ListACLPolicyRequest, opts ...grpc.CallOption) (*ListACLPolicyResponse, error) {
	out := new(ListACLPolicyResponse)
	err := c.cc.Invoke(ctx, "/headscale.v1.HeadscaleService/ListACLPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HeadscaleServiceServer interface {
	...
	// --- ACLs start ---
	ListACLPolicy(context.Context, *ListACLPolicyRequest) (*ListACLPolicyResponse, error)
...
func (UnimplementedHeadscaleServiceServer) ListACLPolicy(context.Context, *ListACLPolicyRequest) (*ListACLPolicyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListACLPolicy not implemented")
}
...
func _HeadscaleService_ListACLPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListACLPolicyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HeadscaleServiceServer).ListACLPolicy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/headscale.v1.HeadscaleService/ListACLPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeadscaleServiceServer).ListACLPolicy(ctx, req.(*ListACLPolicyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HeadscaleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListACLPolicy",
			Handler:    _HeadscaleService_ListACLPolicy_Handler,
		},
	},
